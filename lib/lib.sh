...
#                                                                                    #
# https://github.com/marcelofelipes/jterodactyl-installer/blob/master/LICENSE #
#                                                                                    #
# This script is not associated with the official Pterodactyl Project.               #
# https://github.com/marcelofelipes/jterodactyl-installer                     #
#                                                                                    #
######################################################################################
...
# download URLs
export PANEL_DL_URL="https://github.com/Next-Panel/Jexactyl-BR/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/marcelofelipes/jterodactyl-installer"}
...
welcome() {
  ...
  output "https://github.com/marcelofelipes/jterodactyl-installer"
  output ""
